...
It just resolves an issue of +39 with itlay and vatican city, all things remain the same with ngx-international-phone-number.
This is most of a bug fixed library created by Agha Ali Abbas.
